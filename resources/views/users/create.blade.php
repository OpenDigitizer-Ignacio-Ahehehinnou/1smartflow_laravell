...
@section('content')
        ...
        <form id="signUpForm" method="POST" action="{{ route('user.handle.create') }}" class="form">
            ...
            <div class="step">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" onkeypress="return isLetterKey(event)" placeholder="" value="{{ old('lastname') }}" oninput="this.className = ''"
                            name="lastname">
                    </div>
                    <div class="col mb-3">
                        <label class="form-label">Prénom(s)</label>
                        <input type="text" onkeypress="return isLetterKey(event)"  placeholder="" value="{{ old('firstname') }}" oninput="this.className = ''"
                            name="firstname">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" onkeypress="return isNumberKey(event)" placeholder=""
                            value="{{ old('phone') }}" oninput="this.className = ''" name="phone" id="phone">
                    </div>
                    <div class="col mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" onblur="validateEmail(this)" placeholder="" value="{{ old('email') }}"
                            oninput="this.className = ''" name="email" id="email">
                    ...
                    <div class="col mb-3">
                        ...
                        <select name="functionId" class="form-control mb-3" name="functionId">
                            ...
                            @foreach ($functions as $item)
                                <option value="{{ $item['functionId'] }}" @if (old('functionId') === $item['functionId']) selected @endif>
                                    {{ $item['libelle'] }}</option>
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="step">
                ...
                <div class="mb-2">
                    ...
                    <input id="confirm_password" type="password" placeholder="Confirmer le mot de passe"
                        oninput="this.className = ''" name="confirm">
                </div>
    ...
    <script>
        ...
        function isSpecialCharacter(charCode) {
            ...
            var specialCharacters = [32, 33, 64, 35, 36, 37, 94, 38, 42, 40, 41, 95, 43, 45, 61, 123, 125, 91, 93, 58, 59,
                34, 39, 60, 62, 44, 46, 47, 63
            ];

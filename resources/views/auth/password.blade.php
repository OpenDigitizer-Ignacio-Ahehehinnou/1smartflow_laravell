					...
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							<h1 class="h2">Réinitialisation du mot de passe</h1>
                              ...
                              @if(isset($error))
    <div id="error-message" style="background-color:red;color:white" class="bg-red-200 border border-red-600 text-red-900 px-4 py-3 rounded relative" role="alert">
								...
								<div class="m-sm-3">
									<form method="POST" action="{{ route('auth.handle.password') }}" >
                                        ...
                                        <div class="mb-3">
											...
											<input class="form-control form-control-lg" type="password" id="password" name="password" placeholder="Entrez le nouveau mot de passe" />
										</div>
                                        <div class="mb-3">
											<label class="form-label">Confirmation du mot de passe</label>
											<input class="form-control form-control-lg" id="confirm" type="password" name="confirm" placeholder="Confirmez votre mot de passe" />
                                            <input id="personId" type="hidden" name="personId" value={{ $personId }} />
										</div>
                                        <div class="mb-3" id="error-message" style="color: red;"></div>

										<div class="d-grid gap-2 mt-3">
											<button type="submit" class='btn btn-lg btn-primary' id="submitButton">Enregistrer</button>
										</div>
									</form>
								</div>
							</div>

...
@section('content')
    ...
    <div class="container-form">
        <form id="signUpForm" method="POST" action="{{ route('firm.store') }}" class="form">
            @csrf
            ...
            <div class="step">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" placeholder="COMPANY SARL" oninput="this.className = ''"
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" placeholder="" oninput="this.className = ''" name="enterprise_adress"
                            value="{{ old('enterprise_adress') }}">
                    </div>
                </div>

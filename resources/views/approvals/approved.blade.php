            ...
            <div class="d-flex justify-content-end">
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        <form method="POST" action="{{ route('approval.search1')}}" >
                            @csrf
            ...
            <tbody>
                @foreach ($validate as $item)
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::createFromTimestampMs($item['createdAt'])->format('d-m-Y H:i') }}</td>
                        <td><a title="Consulter" href="{{ route('document.preview', ['documentId' => $item['documentId']]) }}"

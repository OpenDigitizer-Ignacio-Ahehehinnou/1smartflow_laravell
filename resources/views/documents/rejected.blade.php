...
@section('content')
    <div class="mb-3">
        <h5>Liste des documents rejetés</h5>
            ...
            <tbody>
                @foreach ($rejected as $item)
                    <tr>
                        ...
                        <td><a title="Modifier"
                                href="{{ route('document.enhance', ['documentId' => $item['documentId']]) }}"
                                class="btn btn-success mr-1"><i class="fas fa-edit"></i></a>
                            <a title="Relancer" data-key="{{ $item['documentId'] }}" data-bs-toggle="modal" data-key=""
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('document.initiate') }}">
                    ...
                    <div class="modal-body m-3">
                        <p class="mb-0">Voulez vous vraiment relancer ce document ?</p>
                    </div>
